...
| issue 駆動開発（フェーズ分離・issue 化の判断・issue 紐づきブランチ必須・1 issue = 1 branch = 1 PR） | `plugins/claude-harness-kit/shared-rules/issue-driven-development/issue-driven-rule.md` |
